...
export const DEFAULTS: PageValues = {
  ...
  about_story_p3:          'Today, Pryro is the trusted platform for over 64K+ businesses across 2 continents, from startups to enterprises, helping them streamline operations and unlock their full potential.',
  about_values_title:      'Our Values',
  about_value_1_title:     'Mission-Driven',
  about_value_1_desc:      'We exist to empower businesses through innovative technology solutions',
  about_value_2_title:     'Customer-First',
  about_value_2_desc:      'Your success is our success. We listen, adapt, and deliver',
  about_value_3_title:     'Innovation',
  about_value_3_desc:      "Constantly pushing boundaries to stay ahead of tomorrow's challenges",
  about_value_4_title:     'Security & Trust',
  about_value_4_desc:      'Enterprise-grade protection with complete transparency',
  about_cta_badge:         "We're Hiring",
  about_cta_title:         'Join Our Team',
  about_cta_body:          "We're building the future of business software and looking for passionate individuals to join us on this exciting journey.",
