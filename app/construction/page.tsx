        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-[5px] p-6">
              <div className="w-8 h-8 bg-blue-600 rounded-[5px] flex items-center justify-center mb-4 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2 pt-4">
                ...
                <button className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-[5px] text-sm font-medium text-gray-700 transition-colors text-left">Budget Control</button>
                <button className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-[5px] text-sm font-medium text-gray-700 transition-colors flex items-center justify-between">
                  <span>Cash Flow</span>
                  <span className="px-2 py-0.5 bg-blue-600 text-white text-xs rounded-[5px]">Pro</span>
                </button>
                <button className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-[5px] text-sm font-medium text-gray-700 transition-colors text-left">Reporting</button>
              </div>
            </div>
