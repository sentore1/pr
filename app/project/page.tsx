      ...
      <section className="pt-40 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <span className="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-[5px]">Unlimited projects</span>
            <span className="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-[5px]">Real-time collaboration</span>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 pt-4">
                ...
                <button className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-[5px] text-sm font-medium text-gray-700 transition-colors text-left">Kanban Board</button>
                <button className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-[5px] text-sm font-medium text-gray-700 transition-colors text-left">Timeline View</button>
              </div>
            </div>
          </div>
        </div>
