        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-8">
            <aside className="hidden lg:block w-64 flex-shrink-0">
              <div className="sticky top-32 bg-white border border-gray-200 rounded-3xl p-6">
                ...
                <nav className="space-y-2">
                  {[
                    ...
                    <a key={i} href={item.href} className="block text-sm text-gray-600 hover:text-gray-900 py-2 px-3 rounded-lg hover:bg-gray-50 transition-colors">
                      {item.label}
                    </a>
                  ))}
                </nav>
            ...
            <div className="flex-1 min-w-0">
              <div className="bg-white border border-gray-200 rounded-3xl p-6 mb-12">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-normal text-gray-900">Quick Start</h2>
                  <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-full text-sm text-gray-900 hover:bg-gray-50 transition-colors">
              ...
              <div className="grid md:grid-cols-4 gap-6 mb-12">
                {[
                  ...
                  <div key={i} className="bg-white border border-gray-200 rounded-3xl p-6 text-center">
              ...
              <div id="authentication" className="bg-white border border-gray-200 rounded-3xl p-8 mb-12">
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 font-mono text-xs mb-3">
                <div className="text-gray-600">pip install pryro-sdk</div>
              </div>
              <div className="bg-gray-900 rounded-xl p-8 font-mono text-xs">
                  ...
                  <div className="bg-white border border-gray-200 rounded-3xl p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50">
                          <span className="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-700">{item.method}</span>
                          <span className="font-mono text-xs text-gray-900">{item.path}</span>
                        </div>
                      ))}
                    </div>
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-8">
              ...
              <div id="errors" className="bg-gray-900 rounded-3xl p-8 mb-12">
            ...
            <div className="bg-gray-800 rounded-2xl p-6 font-mono text-sm overflow-x-auto">
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 text-center">
                ...
                <a href="/demo" className="inline-flex items-center gap-2 bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors">
